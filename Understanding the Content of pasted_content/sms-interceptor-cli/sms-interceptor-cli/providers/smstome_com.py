...
class SmstomeComProvider(BaseProvider):
    def __init__(self):
        super().__init__("https://smstome.com/")
    ...
    def get_numbers(self):
        ...
        try:
            ...
            country_links = soup.find_all('a', class_='country-list-item')
            
            for link in country_links:
                country_name = link.find('span', class_='country-name').get_text(strip=True)
    ...
    def watch_messages(self, number, sender=None):
        ...
        # This might need adjustment based on how smstome.com structures their number pages
        ...
        with Live(Spinner("dots", text=Text("Aguardando novas mensagens...", style="green")), refresh_per_second=4, console=console) as live:
            while True:
                try:
                    ...
                    # Find messages - this part will be highly specific to smstome.com's HTML structure
